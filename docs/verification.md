...
- [x] The local 0.2.0 Windows offline layout and NSIS installer were rebuilt from an isolated worktree without unrelated WIP; the progress-improved installer SHA-256 is `2186a1c19639c69770f040e11066db82cf799cfd898ba09d1972d47d27ca0ad5`. Provenance records the Cargo.lock SHA-256 and 36 target-resolved Rust components are present in CycloneDX SBOM output.
